        ...
        <div className="w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-400">
                <FooterLink href="/atsresume" text="ATS Check" />
                <FooterLink href="/atsresume" text="Resume Builder" />
                <FooterLink href="/interview-prep" text="Interview Preparation" />
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-400">
                <FooterLink href="/contactUs" text="Contact Us" />
