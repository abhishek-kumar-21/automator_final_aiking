...
const HRProfilePage = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        const findUser = dbRef(db, `hr/${userId}`);
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#F9FAFB] flex flex-col items-center justify-center py-12 px-6 sm:px-12">
        <Link href="/hr" className="absolute top-6 right-6">
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] py-12 px-4 sm:px-6 lg:px-8 pt-24">
      {/* Close Button */}
      <Link href="/hr" className="absolute top-24 right-6 sm:right-10 z-10">
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-2xl overflow-hidden">
            ...
            <div className="bg-gray-50 px-6 py-6 sm:px-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                {!isPremium && (
                    <Link href="/hr/pricing" className="w-full sm:w-auto">
